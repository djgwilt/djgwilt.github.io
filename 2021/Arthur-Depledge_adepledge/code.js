...
function updatePosition() {
	if (xDir != 0) {
		...
		column += xDir
        if (document.getElementById("r" + row + " c" + column).className == "powerUp") {
            powerUp = "yes"
        }
        if (document.getElementById("r" + row + " c" + column).className == "human") {
            score = score + 1
            console.log(score)
            document.getElementById("score").innerText = score

        }
        if (document.getElementById("r" + row + " c" + column).className == "goal") {
            finish()
        }
		...
		if (!document.getElementById("r" + row + " c" + column)) {
			...
			document.getElementById("r" + row + " c" + column).className = "spaceship"
		}
	}	if (yDir != 0) {
        // Set the cell where the car was to empty
		document.getElementById("r" + row + " c" + column).className = "Empty"
