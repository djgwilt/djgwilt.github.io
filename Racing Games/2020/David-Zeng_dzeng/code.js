...
function updatePosition() {
	if (xDir != 0 || yDir != 0 ) {
		...
		if (handleEnd() == false) {
			// Line below is missing the + column from the Id and the carClass should be in quotes (see line 50 for example)
...
// David, javascript uses semi-colons as line ending characters, not colons
// Just let me patch this up for you ...
function handleEnd()
{
