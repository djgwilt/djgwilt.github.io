...
// DJG: javascript is semi-colon delimited, not colon delimited. Change these : line endings to ;
function handleend() {
...
function handleCrash() {
	...
	document.getElementById("Message").innerText = "Again..."
}

function handleWin() {
	window.clearInterval(intervalHandle)
	document.getElementById("Message").innerText = "You have some dedication..."
}