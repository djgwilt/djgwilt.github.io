...
function updatePosition() {
	if (xDir != 0) {
        ...
        // Update the column position for Donald
		column += xDir
        // Re-draw the car (or report a crash)
		if (!document.getElementById("r0 c" + column)) {
			handleCrash()
		} else {
			document.getElementById("r0 c" + column).className = "donald"
		}
	}
}
...
function handleCrash() {
	...
	document.getElementById("Message").innerText = "Donald would NEVER wear that!"
}
