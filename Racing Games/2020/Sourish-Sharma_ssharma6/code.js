...
function updatePosition() {
	if (xDir != 0 || yDir != 0) {
		...
		if (handleEnd() == false) {
			document.getElementById("r" + row + " c" + column).className = virusClass;
		}
	}
}
...
function handleCrash() {
	...
	document.getElementById("Message").innerText = "Oops you got sanitised and the humans won..."
}
