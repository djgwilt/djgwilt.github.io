...
// to remeber uganda knuckles class (ugandaknuckles or ugandaknucklesFlipped)
var ugandaknucklesClass = "ugandaknuckles"
...
function checkKey(e) {
    ...
    if (e.keyCode == '39') {
	    ...
	    xDir = 1
        yDir = 0
        ugandaknucklesClass = "ugandaknuckles"
    } else if (e.keyCode == '37') {
        // left arrow
	    xDir = -1
        yDir = 0
        ugandaknucklesClass = "ugandaknucklesFlipped"
...
function updatePosition() {
	if (xDir != 0 || yDir != 0) {
		...
		if (handleEnd() == false) {
		   document.getElementById("r" + row + " c" + column).className = ugandaknucklesClass
		}
	}
...
function handleWin() {
	window.clearInterval(intervalHandle)
	document.getElementById("Message").innerText = "Victory Royale!"
