...
function updatePosition() {
	...
	if (xDir != 0 || yDir != 0) {
		...
		if (handleEnd() == false) {
			document.getElementById("r" + row + " c" + column).className = "Chunga";
...
document.getElementById("Message").innerText = "Ur bad get good kid"

}

function handleWin() {
	window.clearInterval(intervalHandle)
document.getElementById("Message").innerText = "congrats u escaped the bald man"
