...
def handleWin():
    ...
    document.getElementById("Message").innerText = "Well Done, You beat the dinosaurs!"
    getCell().className = "Trophy"
        
        
# if the car has gone off the table, this tidies up including crash message
def handleCrash():
    window.clearInterval(intervalHandle)
    document.getElementById("Message").innerText = "Oh no you hit the asteroid belt!"
