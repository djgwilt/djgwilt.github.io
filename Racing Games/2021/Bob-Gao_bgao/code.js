...
function updatePosition() {
	if (xDir != 0 || yDir != 0) {
		...
		if (handleEnd() == false) {
			document.getElementById("r" + row + " c" + column).className = "Spongebob"
		}
	}
}
...
function handleCrash() {
	...
	document.getElementById("Message").innerText = "You're bad"
}
function handleWin() {
	window.clearInterval(intervalHandle)
	document.getElementById("Message").innerText = "You're ok at the game"
}
