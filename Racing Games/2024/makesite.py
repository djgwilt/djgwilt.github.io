...
for s in staff:
  ...
  for student in students:
      test_folder(f"{student}") or test_folder(f"{student}/My Racing Game") or test_folder(f"{student}/Unit 12 Racing Game/My Racing Game") or test_folder(f"{student}/Unit 12 - Racing Game/My Racing Game")
...
body = f"""
<body>
  <h1>Year 9 Racing Games June 2024</h1>
  <table> {trs} </table>
</body>
"""
