...
function handleEnd()
{
    if (!document.getElementById("r" + row + " c" + column) || document.getElementById("r" + row + " c" + column).className == "wall") {
        handleCrash();
        return true;
    } else if(document.getElementById("r" + row + " c" + column).className == "pond")
    {
        handleWin();
        return true;
    }
...
function handleCrash() {
	...
	document.getElementById("Message").innerText = "Oops you hit a rock..."
}
...
function handleWin() {
    ...
    if(flagCount == flagMax){
        window.clearInterval(intervalHandle)
        document.getElementById("Message").innerText = "Yummy cabbage! :D" 
    }
