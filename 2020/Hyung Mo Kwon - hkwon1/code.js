...
//to remember orientation of car
var carClass = "Car"
...
function updatePosition() {
	if ((xDir != 0) || (yDir != 0)) {
		...
		} else if (getCell(row, column).className == "nom") {
		incrementScore()
...
function crash() {
	...
	document.getElementById("Message").innerText = "Oops you splatted"
	
}

function win() {
	window.clearInterval(intervalHandle)
	document.getElementById("Message").innerText = "SIUUUU"
}
...
function playmusic() {
var mySound;
mySound = new sound ("Rastamouse.mp3")
if (Car.crashWith(wall[i]))
mySound.playmusic();
