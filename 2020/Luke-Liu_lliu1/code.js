...
column += xDir;
        ...
        if (!document.getElementById("r" + row + " c" + column) || document.getElementById("r" + row + " c" + column).className == "wall" || document.getElementById("r" + row + " c" + column).className == "walls") {
handleCrash();
