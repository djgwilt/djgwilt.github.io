...
function handleCrash() {
   ...
   document.getElementById("Message").innerText = "Oh no you crashed, have another go...";
}
...
function handleWin() {
 ...
 if(flagCount == flagMax)
   window.clearInterval(intervalHandle);
   document.getElementById("Message").innerText = "Congratulations, you won. Here's a joke. What do you call a mosquito's pet rabbit? A bug's bunny.";
}
