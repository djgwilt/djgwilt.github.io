...
class WALL {
  ...
  enemyMove() {
    ...
    let xDistance = ex - x
    let yDistance = ey - y
    if (xDistance > 0 && eableToMoveLeft == true) ex -= 1 //enemy further right than player
    if (xDistance < 0 && eableToMoveRight == true) ex += 1 //enemy further left than player
    if (yDistance > 0 && eableToMoveUp == true) ey -= 1 //enemy further down than player
    if (yDistance < 0 && eableToMoveDown == true) ey += 1 //enemy further up than player
